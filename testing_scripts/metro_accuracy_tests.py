...
met_fn = "test_data/PAE_metro_accuracy/metro_accuracy_MOUT.txt"
coded_fn = "test_data/reference_190325/processed/REFERENCE_CODED_TARGETS_190325.txt"

met = np.loadtxt(met_fn)
coded = np.loadtxt(coded_fn)

nom_fid_fn = "test_data/PAE_metro_accuracy/fid_nominal_pos.csv"
nom_fid = pd.read_csv(nom_fid_fn)

built_fid_fn = "test_data/PAE_metro_accuracy/fid_as_built.csv"
